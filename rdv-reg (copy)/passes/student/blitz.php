...
$request=$con->query("INSERT INTO `".$category."blitz` (kerberos,name,time,status) VALUES ('$kerberos','$name',now(),'$wait')");
$q="INSERT INTO `".$category."blitz` (kerberos,name,time,status) VALUES ('$kerberos','$name',now(),'$wait')";
if($request){

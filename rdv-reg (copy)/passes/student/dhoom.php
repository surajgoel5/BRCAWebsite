...
$request=$con->query("INSERT INTO `".$category."dhoom` (kerberos,name,time,status) VALUES ('$kerberos','$name',now(),'$wait')");
if($request){
    die('{"success":true,"message":"Confirmed passes are over, we are opening 500 waitlisted passes"}');
}
else

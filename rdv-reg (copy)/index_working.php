...
$th=$dt->format('G');
$allowed=false;
if(($td=="18"||$td=="19"||$td=="20")&&($th=="13"||$th=="14"||$th=="19"||$th=="20"||$th=="21")) $allowed=true;
?>
<body style="
	overflow: hidden;
...
<a style="position: absolute;color: white;text-decoration: none;display: block;margin-left: 3vw;
    margin-top: 1vh;
...
<h2 class="panel-heading" style="padding:0px;margin-left:3vw; color:#fff;font-size:2.2vw;font-weight:bold;">to ONLINE PASS SYSTEM!</h2>
<img style="width:30vw;height:auto;margin-top:3vh;margin-left:3vw;transform: translateX(-4%)" src="../images/logo.png">
<div class="row" style="margin-left:3vw;color:#fff;margin-top:3vh;">
	<div class="col-md-7 col-sm-7">
		<h3 style="font-size:2.5vh;line-height:3.5vh">
            ...
            <br>
			The System will open for Staff at 01:00 - 03:00 PM<br/>
              Faculty at 07:00 - 09:00 PM<br />
...
<br>
<br>
<div style="color:white;padding-left:3vw">
